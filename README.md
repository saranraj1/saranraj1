...
* **[01] [TITAN](https://github.com/saranraj1/Titan)** &nbsp;·&nbsp; **Change-Aware Code Intelligence**  
  Predicts semantic blast radius of code changes via Tree-sitter AST proof trees and Git co-change graphs.  
  `Python` · `Tree-sitter` · `Datalog` · `NetworkX`

* **[02] [DARA v2](https://github.com/saranraj1/DARA-v2)** &nbsp;·&nbsp; **Autonomous Software Repair**  
  Closed-loop fault localization and patch synthesis verified inside isolated Docker sandboxes.  
  `Python` · `Multi-Agent` · `Docker SDK` · `Neo4j`

* **[03] [SILENTBIAS](https://github.com/saranraj1/SilentBias)** &nbsp;·&nbsp; **Latent Proxy Leakage & Fairness**  
  Adversarial shadow probes detecting hidden demographic reconstruction in sanitized embedding spaces.  
  `PyTorch` · `Scikit-learn` · `Representation Probing`

* **[04] [AGENT-NOIR](https://github.com/saranraj1/AGENT-NOIR)** &nbsp;·&nbsp; **Deception & Multi-Agent Reliability**  
  Game-theoretic verifier protocols eliminating strategic deceit across multi-agent workflows.  
  `TypeScript` · `Python` · `Deterministic Sim` · `Audit Logging`

---

### Failure Lab

An empirical loop testing model breakdown boundaries under distribution shift:
...
<p align="center">
  <a href="https://github.com/saranraj1/data_decay"><b>Data Decay</b></a> (drift) &nbsp;·&nbsp;
  <a href="https://github.com/saranraj1/OOD-explorer"><b>OOD Explorer</b></a> (shift) &nbsp;·&nbsp;
  <a href="https://github.com/saranraj1/MissingnessMatter"><b>MissingnessMatter</b></a> (tabular) &nbsp;·&nbsp;
  <a href="https://github.com/saranraj1/Fragility_index"><b>Fragility Index</b></a> (brittleness) &nbsp;·&nbsp;
  <a href="https://github.com/saranraj1/XAI-Lab"><b>XAI Lab</b></a> (attribution)
</p>
...
`STACK` Python · PyTorch · TypeScript · FastAPI · Docker · PostgreSQL · Redis · Neo4j
